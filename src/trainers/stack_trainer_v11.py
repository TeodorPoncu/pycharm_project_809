...
class StackTrainer(BaseModel):
    ...
    def init_trainer_network(self):
        ...
        #self.optim_language = RMSprop(self.language_params, lr=self.cfg.lang_lr, momentum=self.cfg.lang_mom,
        #                                                  alpha=self.cfg.lang_alpha, weight_decay=self.cfg.lang_wd)
